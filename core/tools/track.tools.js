...
register({
  ...
  input_schema: {
    ...
    properties: {
      ...
      start_slide_id: { type: "string", nullable: true, description: "재생 시작 슬라이드(생략 시 첫 슬라이드)" },
      end_slide_id: { type: "string", nullable: true, description: "재생 끝 슬라이드(생략·null이면 예배 끝까지)" },
